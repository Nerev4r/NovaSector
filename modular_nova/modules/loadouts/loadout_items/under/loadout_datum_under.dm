...
/datum/loadout_item/under/jumpsuit/security_skirt
	name = "Security Skirt"
	item_path = /obj/item/clothing/under/rank/security/peacekeeper/trousers/skirt
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_HEAD_OF_SECURITY)

/datum/loadout_item/under/jumpsuit/security_skirtleneck
	name = "Security Skirt"
	item_path = /obj/item/clothing/under/rank/security/peacekeeper/skirtleneck
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_HEAD_OF_SECURITY)
